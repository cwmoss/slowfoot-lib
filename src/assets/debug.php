...
<div id="debug-panel" style="display:none;position:fixed;z-index:122;padding:16px;max-height:90vh;max-width:60vw;overflow-y:scroll;top:16px;left:16px;background-color:white;color:black;font-size:14px;line-height:16px;"><code><pre id="debug-panel-content" style="white-space: pre-wrap;"></pre></code></div>
<script>
